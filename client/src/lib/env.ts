...
export const socketUrl = `PROTOCOL://${baseUrl}/socket`.replace('PROTOCOL', secure ? 'wss' : 'ws');
export const apiUrl = `PROTOCOL://${baseUrl}/api`.replace('PROTOCOL', secure ? 'https' : 'http');
